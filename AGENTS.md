...
- Runner policy: ordinary Linux jobs in this public repository use GitHub-hosted Ubuntu 24.04. Private specialized macOS, Xcode, and signing jobs retain their matching self-hosted capability pools. Public security workflows use GitHub-hosted isolation; fork pull-request jobs always remain read-only and GitHub-hosted.
