...
require_pattern "$DOC_PATH" "APW_SPARKLE_PRIVATE_ED_KEY" "ephemeral runner Sparkle private key configuration"
...
require_pattern "$PREPARE_SCRIPT" "APW_SPARKLE_PRIVATE_ED_KEY" "ephemeral runner private key input"
require_pattern "$PREPARE_SCRIPT" "--ed-key-file -" "Sparkle private key standard input"
...
require_pattern "$RELEASE_WORKFLOW" "APW_SPARKLE_PRIVATE_ED_KEY" "release Sparkle private key secret"
require_pattern "$RELEASE_WORKFLOW" "sparkle-release" "Sparkle-capable Lume runner label"
